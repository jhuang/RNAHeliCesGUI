...
public class ControleurInterpolator extends Thread {
	 ...
	 * in the given array.
	 */
	private Point2D.Double computeCentroid(ArrayList<ModeleBase> rnaBases, int[] indexes) {		
	 ...
	 */
	private double minimizeRotateRMSD(double[] X1, double[] Y1, double[] X2, double[] Y2) {
	 ...
	 */
	public void moveNearOtherRNA(RNA rna1, RNA rna2, Mapping mapping) {
