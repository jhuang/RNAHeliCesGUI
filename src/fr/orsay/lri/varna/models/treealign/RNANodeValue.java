...
public class RNANodeValue implements GraphvizDrawableNodeValue {
	...
	private char leftNucleotide = '_';
	private char rightNucleotide = '_';
	...
	public char getLeftNucleotide() {
		return leftNucleotide;
	}
	public void setLeftNucleotide(char leftNucleotide) {
		this.leftNucleotide = leftNucleotide;
	}
	public char getRightNucleotide() {
		return rightNucleotide;
	}
	public void setRightNucleotide(char rightNucleotide) {
	...
	public String toGraphvizNodeName() {
		if (rightNucleotide == '_') {
			if (leftNucleotide == '_') {
				...
				return Character.toString(leftNucleotide);
			}
		} else {
