...
public class VARNAConfig implements Serializable, Cloneable {
	...
	public static final Color BASE_INNER_COLOR_DEFAULT = new Color(240, 240,240);
	...
	public static final Font DEFAULT_TITLE_FONT = new Font("Arial", Font.PLAIN,
			18);
	public static final Font DEFAULT_BASE_FONT = new Font("Arial", Font.BOLD,
			18);
	public static final Font DEFAULT_NUMBERS_FONT = new Font("Arial",
			Font.BOLD, 18);
